...
import com.home.creator.principle1.goodExample.Calculator;
...
public class TestCreatorPattern  {
    ...
    public void testCreatorPrincipleGoodExample() throws Exception {
        Class<?> clazz = Class.forName("com.home.creator.principle1.goodExample.ReportGenerator");
    ...
    public void testCreatorPrincipleBadExample() throws Exception {
        Class<?> clazz = Class.forName("com.home.creator.principle1.badExample.ReportGenerator");
