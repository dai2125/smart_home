            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                if(designSmell.equals("Broken Hierarchy")) {
                    ...
                    if(clazz.isInterface() || Modifier.isAbstract(clazz.getModifiers())) {
                        ...
                        OpenClosedDataModel openClosedDataModel = getOpenClosedDataModel(something);
...
//                    System.out.println(test);
    ...
    public OpenClosedDataModel getOpenClosedDataModel(String name) {
        OpenClosedDataModel openClosedDataModel = null;
        String line = "";
        String splitBy = ",";
