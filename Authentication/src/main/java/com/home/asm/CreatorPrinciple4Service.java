...
public class CreatorPrinciple4Service {
    ...
    public static String analyzeClassFields(String className, String sourceCode) {
        ...
        compilationUnit.accept(new ASTVisitor() {
            ...
            public boolean visit(MethodDeclaration node) {
                ...
                InspectedMethod inspectedMethod = new InspectedMethod(node.isConstructor(), node.getName().getIdentifier(), modifiers);
...
//                    System.out.println(node.parameters().size());
                    ...
                    for(Object param : node.parameters()) {
                        if(param instanceof SingleVariableDeclaration) {
                            ...
                            inspectedMethod.addToParameterFieldList(paramType, paramName);
