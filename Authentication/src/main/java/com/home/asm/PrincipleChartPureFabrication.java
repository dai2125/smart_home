...
// public class PrincipleChartPureFabrication {
...
public class PrincipleChartPureFabrication extends JFrame {
    ...
    public PrincipleChartPureFabrication() {
...
//        setContentPane(panel);
    ...
    private JPanel createHeatmapTablePanel() {
        ...
        chartInfoPanel.setPreferredSize(new Dimension(1000, 220));
        chartInfoPanel.setLayout(new BorderLayout());
        chartInfoPanel.setBackground(Color.WHITE);
        String[] columnNames = { "Class", "NoF", "NoM", "WMC", "NC", "DIT", "Yalcom", "FanIn", "FanOut" };
        Object[][] data = {
                {
                        "Command",
                        1,
...
// Spaltenüberschriften fett formatieren
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            PrincipleChartPureFabrication example = new PrincipleChartPureFabrication();
