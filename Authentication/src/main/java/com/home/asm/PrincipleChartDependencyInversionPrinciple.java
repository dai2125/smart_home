...
// public class PrincipleChartDependencyInversionPrinciple {
...
public class PrincipleChartDependencyInversionPrinciple extends JFrame {
    ...
    public PrincipleChartDependencyInversionPrinciple() {
...
//        setContentPane(panel);
    ...
    private JPanel createHeatmapTablePanel() {
        ...
        chartInfoPanel.setPreferredSize(new Dimension(1000, 150));
        chartInfoPanel.setLayout(new BorderLayout());
        chartInfoPanel.setBackground(Color.WHITE);
        String[] columnNames = { "Class", "Interface", "(NoIM/NoM)", "WMC", "NC", "DIT", "LCOM", "FanIn", "FanOut" };
        Object[][] data = {
                {
                        "Book",
                        "False",
...
// Spaltenüberschriften fett formatieren
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            PrincipleChartDependencyInversionPrinciple example = new PrincipleChartDependencyInversionPrinciple();
