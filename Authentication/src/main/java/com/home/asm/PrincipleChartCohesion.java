...
public class PrincipleChartCohesion extends JFrame {
...
//        setContentPane(panel);
    ...
    private JPanel createHeatmapTablePanel() {
        ...
        chartInfoPanel.setPreferredSize(new Dimension(1000, 390));
        chartInfoPanel.setLayout(new BorderLayout());
        chartInfoPanel.setBackground(Color.WHITE);
        String[] columnNames = { "Class", "NouF", "NoF", "NoM", "LCOM1", "LCOM2", "LCOM3", "LCOM4", "LCOM5", "Yalcom" };

        Object[][] data = { //TODO ´richtig einrücken und dann noch ein Leerzeichen für values kleiner 10 damit als gleich formatiert ist und 0.4 = 0.40
                {
                        "Example",
                        4,
                        7,
                ...
                },
                {
                        ...
                        5.0,
                        5.0,
                        0.91, //0.9166666666666666,
                        0.71, //0.7142857142857143,
                },
                {
                        "Example5",
                        0,
...
// Spaltenüberschriften fett formatieren
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            PrincipleChartCohesion example = new PrincipleChartCohesion();
