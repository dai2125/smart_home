...
// public class PrincipleChartLooseCoupling {
...
public class PrincipleChartLooseCoupling extends JFrame {
    ...
    public PrincipleChartLooseCoupling() {
...
//        setContentPane(panel);
    ...
    private JPanel createHeatmapTablePanel() {
        ...
        String[] columnNames = { "Class", "NoM", "NoIm", "Interface", "NC", "DIT", "FanIn", "FanOut" };
        Object[][] data = {
                {
                        "Computer",
                        1,
...
// Spaltenüberschriften fett formatieren
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            PrincipleChartLooseCoupling example = new PrincipleChartLooseCoupling();
