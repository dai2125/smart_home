...
public class LiskovSubstitutionPrincipleService {

    // TODO Lines Of Code beide Funktionen haben gleich viele Zeilen!
    /**
    ...
    **/
    ...
    public static String liskovSubstitutionPrinciple(InspectedClass inspectedClass) {
