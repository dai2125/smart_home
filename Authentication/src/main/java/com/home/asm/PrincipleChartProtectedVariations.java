...
public class PrincipleChartProtectedVariations extends JFrame {
    ...
    public PrincipleChartProtectedVariations() {
    ...
    private JPanel createHeatmapTablePanel() {
        ...
        chartInfoPanel.setPreferredSize(new Dimension   (1000, 165));
        chartInfoPanel.setLayout(new BorderLayout());
        chartInfoPanel.setBackground(Color.WHITE);
        String[] columnNames = { "Class", "NoIM", "NoM", "WMC", "NC", "DIT", "Yalcom", "FanIn", "FanOut" };
        Object[][] data = {
                {
                        "CreditCardPayment",
                        1,
...
// Spaltenüberschriften fett formatieren
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            PrincipleChartProtectedVariations example = new PrincipleChartProtectedVariations();
